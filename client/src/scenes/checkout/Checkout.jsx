...
const stripePromise = loadStripe(
  "pk_test_51Nf7uUIBPTwQomGFshoalUMxHb0I3DRiUOsKoGy0mJAHtvcFP8RIjiXbXNHOcIBp4PeB5aWg29wIYA1t2hJPdYJW00ZTkgtZHB"
);
const initialValues = {
  billingAddress: {
    firstName:"",
                ...
                <Box display="flex" justifyContent="space-between" gap="50px">
                  {
                    isSecondStep && (
                      <Button sx={{
                        ...
                        borderRadius: 0,
                        padding: "15px 40px",
                      }} fullWidth color='primary' variant='contained' onClick={()=> setActiveStep(activeStep-1)}>
                        Back
                      </Button>
                    )
                  }
                    ...
                    borderRadius: 0,
                    padding: "15px 40px",
                  }} fullWidth type='submit' color='primary' variant='contained'>
